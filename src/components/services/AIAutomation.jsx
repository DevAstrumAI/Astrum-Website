...
const AIAutomation = () => {
  const serviceData = ServiceData.find((s) => s.slug === "ai-automation");
    ...
    <ServiceBaseLayout serviceData={serviceData}>
      <div className="max-w-7xl mx-auto px-6 py-10 md:py-14 grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
        <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8 }}
          ...
          <p className="text-[11px] uppercase tracking-[0.22em] text-gray-600">Service · AI Automation</p>
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-extralight text-gray-100 leading-[1.15] tracking-[-0.02em]">
            <span className={ACCENT}>AI Automation</span> for Smarter Business Operations
          </h1>
          <div className={DIVIDER} />
          <p className="text-base text-gray-400 font-light leading-[1.8] max-w-md">
            We design AI-driven automation systems that reduce manual effort, streamline workflows, and improve operational accuracy at scale.
          </p>
          <Link to="/portfolio"
        ...
        <div className="relative flex justify-center lg:justify-end order-1 lg:order-2 w-full">
          <ServiceHeroVisual src="https://res.cloudinary.com/deykcfhzj/image/upload/v1771999131/ai-automation_kyawst.png" alt="AI Automation" />
        </div>
      </div>
    </ServiceBaseLayout>
  );
