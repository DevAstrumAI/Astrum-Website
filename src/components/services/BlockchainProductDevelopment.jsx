...
const BlockchainProductDevelopment = () => {
  const serviceData = ServiceData.find((s) => s.slug === "blockchain-product-development");
    ...
    <ServiceBaseLayout serviceData={serviceData}>
      <div className="max-w-7xl mx-auto px-6 py-10 md:py-14 grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
        <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8 }}
          ...
          <p className="text-[11px] uppercase tracking-[0.22em] text-gray-600">Service · Blockchain Development</p>
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-extralight text-gray-100 leading-[1.15] tracking-[-0.02em]">
            Secure and Scalable <span className={ACCENT}>Blockchain Product</span> Development
          </h1>
          <div className={DIVIDER} />
          <p className="text-base text-gray-400 font-light leading-[1.8] max-w-md">
            From smart contracts to full-scale decentralized platforms, we build secure, transparent blockchain solutions for modern digital ecosystems.
          </p>
          <Link to="/portfolio"
        ...
        <div className="relative flex justify-center order-1 lg:order-2 w-full">
          <ServiceHeroVisual src="https://res.cloudinary.com/deykcfhzj/image/upload/v1771999134/blockchain-product-development_fozvl4.png" alt="Blockchain Product Development" />
        </div>
      </div>
    </ServiceBaseLayout>
  );
...
export default BlockchainProductDevelopment;
