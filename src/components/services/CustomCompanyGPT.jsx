...
const CustomCompanyGPT = () => {
  const serviceData = ServiceData.find((s) => s.slug === "custom-company-gpt");
    ...
    <ServiceBaseLayout serviceData={serviceData}>
      <div className="max-w-7xl mx-auto px-6 py-10 md:py-14 grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
        <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8 }}
          ...
          <p className="text-[11px] uppercase tracking-[0.22em] text-gray-600">Service · Custom Company GPT</p>
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-extralight text-gray-100 leading-[1.15] tracking-[-0.02em]">
            Private <span className={ACCENT}>Custom GPT</span> Solutions for Enterprises
          </h1>
          <div className={DIVIDER} />
          <p className="text-base text-gray-400 font-light leading-[1.8] max-w-md">
            Secure, private GPT models customized to your internal workflows and proprietary knowledge — enhancing productivity, automating processes, and safeguarding sensitive data.
          </p>
          <Link to="/portfolio"
        ...
        <div className="relative flex justify-center lg:justify-end w-full order-1 lg:order-2">
          <ServiceHeroVisual src="https://res.cloudinary.com/deykcfhzj/image/upload/v1771999129/custom-company-gpt_hntlcc.png" alt="Custom Company GPT" />
        </div>
      </div>
    </ServiceBaseLayout>
  );
...
export default CustomCompanyGPT;
